            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                        <form action="StatusEdit?id=<%= id %>" class="form form-group" method="POST">
                            <table>
                                <tr>
                                    <td class="col-md-1">
                                        <label>ID</label>
                                    ...
                                    <td>
                                        <input type="text" name="idBaru" value="<%= s.getId_status()%>" class="form-control" onkeypress="return pronim(event)" required/><br/>
                                    </td>
                                </tr>
                                <tr>
                                <td class="col-md-1">
