 ...
 * @author Surya
 */
@WebServlet(name = "SusuView", urlPatterns = {"/SusuView"})
public class SusuView extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("username")==null){
            ...
            String title="Lihat Daftar Susu";
            request.setAttribute("t", title);
            rd = request.getRequestDispatcher("/view/susuView.jsp");
            rd.forward(request, response);
        }}
